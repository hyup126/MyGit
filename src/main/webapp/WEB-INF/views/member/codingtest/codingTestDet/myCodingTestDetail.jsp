		...
		<form action="/member/updateSolutionYn" method="post" id="prctQuesNoForm">
			...
			<div>
				...
				<div class="run-section">
			        <div id="monaco" style="width: 100%; height: 400px;"><input type="hidden" value='${codingTestVO.prctQuesAns }' name="prctQuesAns" id="myAns"></div>
			        <hr/>
			...
			<div class="button-section">
				...
				<button type="button" class="w3-button w3-blue w3-round" id="updateBtn">수정하기</button>
			</div>
		</form>
	</div>
	...
	<script type="text/javascript">
		...
		$(function(){
		    ...
		    updateBtn.on('click', function(){
			    ...
			    $('#myAns').val(editor.getModel().getValue());
		    	console.log("compileRes : " + compileRes);
		    	console.log("ex : " + ex);
		    	console.log("editor.getModel().getValue() : " + editor.getModel().getValue());
		    ...
		    listBtn.on('click', function(){
		    	location.href = "/member/myCodingTest";
		    });
		});
	</script>
</body>
