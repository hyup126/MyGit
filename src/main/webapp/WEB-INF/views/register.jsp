...
<button type="button" id="businessBtn" name="membership" onclick="showForm('businessForm')" class="btn btn-secondary btn-sm">기업회원가입</button>
        <form>
         <div class="text-center">
				<img class="img-fluid profile-image-pic img-thumbnail rounded-circle my-3" id="profileImg"
					src="https://cdn.pixabay.com/photo/2016/03/31/19/56/avatar-1295397__340.png" alt="profile"
					style="width: 200px;">
			</div>
