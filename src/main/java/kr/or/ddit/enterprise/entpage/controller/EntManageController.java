...
public class EntManageController {
	...
	@GetMapping("/entManage")
	public String entManage(EnterpriseMemberVO entmember,Model model, HttpServletRequest req, RedirectAttributes ra) {
		...
		if(sessionEnt == null) {
			...
			entmember = eaService.getEntManage(entmemberId);
			model.addAttribute("entmember",entmember);
			goPage = "enterprise/entinfo/entManage";
