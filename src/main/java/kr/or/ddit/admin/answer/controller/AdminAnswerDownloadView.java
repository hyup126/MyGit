...
public class AdminAnswerDownloadView extends AbstractView {

	@Override
	protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		Map<String, Object> answerFileMap = (Map<String, Object>) model.get("answerFileMap");
		
		File saveFile = new File(answerFileMap.get("fileSavepath").toString());
		String fileName = answerFileMap.get("fileName").toString();
		String fileSize = answerFileMap.get("fileSize").toString();
